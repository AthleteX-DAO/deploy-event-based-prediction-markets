...
const TEAMS: Team[] = [
  { key: "FALCONS",      nickname: "Falcons",      fullName: "Atlanta Falcons" },
  { key: "PANTHERS",     nickname: "Panthers",     fullName: "Carolina Panthers" },
  { key: "SAINTS",       nickname: "Saints",       fullName: "New Orleans Saints" },
  { key: "BUCCANEERS",   nickname: "Buccaneers",   fullName: "Tampa Bay Buccaneers" },

  { key: "CARDINALS",    nickname: "Cardinals",    fullName: "Arizona Cardinals" },
  { key: "RAMS",         nickname: "Rams",         fullName: "Los Angeles Rams" },
  { key: "49ERS",        nickname: "49ers",        fullName: "San Francisco 49ers" },
  { key: "SEAHAWKS",     nickname: "Seahawks",     fullName: "Seattle Seahawks" },
];
