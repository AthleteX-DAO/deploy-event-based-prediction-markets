...
const TEAMS: Team[] = [
  { key: "COWBOYS",      nickname: "Cowboys",      fullName: "Dallas Cowboys" },
  { key: "GIANTS",       nickname: "Giants",       fullName: "New York Giants" },
  { key: "EAGLES",       nickname: "Eagles",       fullName: "Philadelphia Eagles" },
  { key: "COMMANDERS",   nickname: "Commanders",   fullName: "Washington Commanders" },

  { key: "BEARS",        nickname: "Bears",        fullName: "Chicago Bears" },
  { key: "LIONS",        nickname: "Lions",        fullName: "Detroit Lions" },
  { key: "PACKERS",      nickname: "Packers",      fullName: "Green Bay Packers" },
  { key: "VIKINGS",      nickname: "Vikings",      fullName: "Minnesota Vikings" },
];
